...
if("TRUE" STREQUAL "TRUE")
  set(cv_bridge_SOURCE_PREFIX /home/pedrosc/robotics/src/cv_bridge)
  set(cv_bridge_DEVEL_PREFIX /home/pedrosc/robotics/devel)
  ...
  set(cv_bridge_INSTALL_PREFIX /home/pedrosc/robotics/install)
...
if(NOT "/home/pedrosc/robotics/src/cv_bridge/include;/usr/local/include;/usr/local/include/opencv " STREQUAL " ")
  set(cv_bridge_INCLUDE_DIRS "")
  set(_include_dirs "/home/pedrosc/robotics/src/cv_bridge/include;/usr/local/include;/usr/local/include/opencv")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'cv_bridge' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/pedrosc/robotics/src/cv_bridge/${idir}'.  ${_report}")
    endif()
    _list_append_unique(cv_bridge_INCLUDE_DIRS ${include})
  endforeach()
endif()

set(libraries "cv_bridge;/usr/local/lib/libopencv_core.so.3.4.5;/usr/local/lib/libopencv_imgproc.so.3.4.5;/usr/local/lib/libopencv_imgcodecs.so.3.4.5;/usr/local/lib/libopencv_dnn.so.3.4.5")
